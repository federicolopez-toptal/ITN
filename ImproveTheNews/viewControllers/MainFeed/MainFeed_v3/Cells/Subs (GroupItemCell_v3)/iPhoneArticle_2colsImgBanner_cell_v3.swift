//
//  iPhoneArticle_2colsImgBanner_cell_v3.swift
//  ImproveTheNews
//
...
class iPhoneArticle_2colsImgBanner_cell_v3: GroupItemCell_v3 {

    static let identifier = "iPhoneArticle_2colsImgBanner_cell_v3"
    var isBanner = false
