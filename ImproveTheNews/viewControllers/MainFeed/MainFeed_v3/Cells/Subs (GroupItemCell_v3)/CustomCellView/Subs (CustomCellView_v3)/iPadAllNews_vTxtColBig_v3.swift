//
//  iPadAllNews_vTxtColBig_v3.swift
//  ImproveTheNews
//
...
class iPadAllNews_vTxtColBig_v3: CustomCellView_v3 {
...
//        self.mainImageView.setSmallLoading()
    ...
    // Story
        ...
        self.storyTitleLabel.activateConstraints([
            ...
            self.storyTitleLabel.topAnchor.constraint(equalTo: self.topAnchor, constant: -10)
        ])
    ...
    // Article
        ...
        self.articleTitleLabel.activateConstraints([
            ...
            self.articleTitleLabel.topAnchor.constraint(equalTo: self.topAnchor),
        ])
...
extension iPadAllNews_vTxtColBig_v3: StanceIconViewDelegate {
