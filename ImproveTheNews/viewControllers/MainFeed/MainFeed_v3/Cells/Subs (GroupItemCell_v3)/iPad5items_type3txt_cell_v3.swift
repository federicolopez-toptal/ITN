//
//  iPad5items_type3txt_cell_v3.swift
//  ImproveTheNews
//
...
class iPad5items_type3txt_cell_v3: GroupItemCell_v3 {

    static let identifier = "iPad5items_type3txt_cell_v3"
    ...
    private func buildContent() {
        ...
        ///
        let view4 = iPhoneAllNews_vTxtCol_v3_B(width: colW)
        ...
        view4.activateConstraints([
            ...
            view4.leadingAnchor.constraint(equalTo: self.contentView.leadingAnchor, constant: sep),
        ...
        ///
        let view5 = iPhoneAllNews_vTxtCol_v3_B(width: colW)
        ...
        self.view6_heightConstraint = view5.heightAnchor.constraint(equalToConstant: 1)
        self.view6_heightConstraint.isActive = true
        
        ///
        let view2 = iPhoneAllNews_vTxtCol_v3_B(width: colW)
        self.contentView.addSubview(view2)
        view2.activateConstraints([
            view2.topAnchor.constraint(equalTo: self.contentView.topAnchor),
            view2.leadingAnchor.constraint(equalTo: view4.trailingAnchor, constant: sep),
        ...
        ///
        let view3 = iPhoneAllNews_vTxtCol_v3_B(width: colW)
    ...
    override func populate(with group: DP3_groupItem) {
        ...
        view1_heightConstraint.constant = (self.subViews[0] as! iPadAllNews_vTxtColBig_v3).calculateHeight()
        view2_heightConstraint.constant = (self.subViews[1] as! iPhoneAllNews_vTxtCol_v3_B).calculateHeight()
    ...
    func calculateGroupHeight() -> CGFloat {
        let height_1 = (self.subViews[0] as! iPadAllNews_vTxtColBig_v3).calculateHeight()
        let height_2 = (self.subViews[1] as! iPhoneAllNews_vTxtCol_v3_B).calculateHeight()
