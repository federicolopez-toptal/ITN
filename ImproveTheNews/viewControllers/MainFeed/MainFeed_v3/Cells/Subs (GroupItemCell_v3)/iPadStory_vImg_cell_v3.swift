...
class iPadStory_vImg_cell_v3: GroupItemCell_v3 {

    static let identifier = "iPadStory_vImg_cell_v3"
    ...
    private func buildContent() {
        ...
        let view1 = iPadStory_vImg_v3(width: SCREEN_SIZE().width - IPAD_sideOffset())
    ...
    override func populate(with group: DP3_groupItem) {
        ...
        view1_heightConstraint.constant = (self.subViews[0] as! iPadStory_vImg_v3).calculateHeight()
    ...
    func calculateGroupHeight() -> CGFloat {
        return (self.subViews[0] as! iPadStory_vImg_v3).calculateHeight()
    }
}
