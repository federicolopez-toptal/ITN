...
class iPhoneStory_vTxtDescr_cell_v3: GroupItemCell_v3 {

    static let identifier = "iPhoneStory_vTxtDescr_cell_v3"
    ...
    private func buildContent() {
        ...
        ///
        let view1 = iPhoneStory_vTxtDescr_v3(width: SCREEN_SIZE().width)
    ...
    override func populate(with group: DP3_groupItem) {
        ...
        let view1 = self.subViews[0] as! iPhoneStory_vTxtDescr_v3
    ...
    func calculateGroupHeight() -> CGFloat {
        return (self.subViews[0] as! iPhoneStory_vTxtDescr_v3).calculateHeight()
    }
}
