//
//  iPadControversyNarrowCell_v3.swift
//  ImproveTheNews
//
...
class iPadControversyNarrowCell_v3: UITableViewCell {

    static let identifier = "iPadControversyNarrowCell_v3"
    ...
    func populate(item1: ControversyListItem, item2: ControversyListItem?, remark: String? = nil) {
        let view1 = self.subViews[0]
        view1.populate(with: item1, remark: remark)
        view1_heightConstraint.constant = view1.calculateHeight()
        
        let view2 = self.subViews[1]
        if let _item2 = item2 {
            view2.populate(with: _item2, remark: remark)
