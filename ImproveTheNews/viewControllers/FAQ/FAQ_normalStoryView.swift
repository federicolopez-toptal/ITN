...
class FAQ_normalStoryView: CustomCellView {
    ...
    private func buildContent() {
        ...
        vStack.activateConstraints([
            ...
            vStack.topAnchor.constraint(equalTo: self.topAnchor, constant: 150)
        ])
    ...
    override func getHeight(forColumnWidth columnW: CGFloat) -> CGFloat {
        let H: CGFloat = 150 + 23 + 10 + self.titleLabel.calculateHeightFor(width: columnW-(IPAD_INNER_MARGIN*2)) + 14 + 18 + 10 + 18 + 15
        return H
    }
