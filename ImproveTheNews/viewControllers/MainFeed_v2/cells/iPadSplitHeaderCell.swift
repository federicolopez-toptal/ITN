...
class iPadSplitHeaderCell: UITableViewCell {
    ...
    private func buildContent() {
        ...
        hStack.activateConstraints([
            ...
            hStack.topAnchor.constraint(equalTo: self.contentView.topAnchor, constant: 30)
        ])
        
//        self.titleLabel_1.textAlignment = .center
//        self.titleLabel_2.textAlignment = .center
        ...
        self.vLine.activateConstraints([
            ...
            self.vLine.topAnchor.constraint(equalTo: self.contentView.topAnchor, constant: 30),
