...
protocol NLTextViewDelegate: AnyObject {
    func NLTextView_onTextChange(sender: FormTextView, text: String)
    func NLTextView_onReturnTap(sender: FormTextView)
}


class NLTextView: UIView {
...
extension NLTextView: UITextFieldDelegate {
